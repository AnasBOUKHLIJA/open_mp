...
declare -a programs=("monte_carlo_pi_sequential.c"
                    "monte_carlo_pi_parallel.c"
                    "monte_carlo_pi_parallel_optimizations.c"
                    "monte_carlo_pi_parallel_optimizations_test.c"
                    )
