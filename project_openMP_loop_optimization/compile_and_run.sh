...
declare -a programs=("simple_loop_no_openmp_no_optimization.c"
                     "simple_loop_no_optimization.c"
                     "loop_unrolling_openmp.c"
                     "loop_fusion_openmp.c"
                     "combined_optimizations_openmp.c")
